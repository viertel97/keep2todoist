...
MASTER_KEY, CATEGORIES_BIN, RENAIMING_BIN = get_secrets(["jsonbin/masterkey", "jsonbin/categories-bin", "jsonbin/renaiming-bin"])
...
VOICE_ARTIFACT_PATTERNS = [
	r"\bauf\s+(die|meine|unsere|den|das|dem|der)(\s+(einkaufsliste|einkaufszettel|einkaufs|liste|todo[- ]?liste|to[- ]?do[- ]?liste|to[- ]?do[-]?))?\s*$",
	r"\bin\s+(die|meine|unsere|den|das|dem|der)(\s+(einkaufsliste|einkaufszettel|einkaufs|liste|todo[- ]?liste|to[- ]?do[- ]?liste|to[- ]?do[-]?))?\s*$",
	r"\bzu\s+(der|meiner|meinem|dem|den)(\s+(einkaufsliste|einkaufszettel|einkaufs|liste|todo[- ]?liste|to[- ]?do[- ]?liste|to[- ]?do[-]?))?\s*$",
	r"\bfür\s+(die|meine|unsere|den|das)(\s+(einkaufsliste|einkaufszettel|einkaufs|liste|todo[- ]?liste|to[- ]?do[- ]?liste|to[- ]?do[-]?))?\s*$",
	r"\ban\s+(die|meine|den|das)(\s+(einkaufsliste|einkaufszettel|einkaufs|liste|todo[- ]?liste|to[- ]?do[- ]?liste|to[- ]?do[-]?))?\s*$",
